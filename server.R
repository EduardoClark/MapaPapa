...
#Icons
EventIcon <- makeIcon(
  iconUrl = "http://104.236.151.123:3838/mapapapa/assets/papa01-icono.png",
  iconWidth = 20, iconHeight = 20
)
AyudaIcon <- makeIcon(
  iconUrl = "http://104.236.151.123:3838/mapapapa/assets/papa01-icono02.png",
  iconWidth = 20, iconHeight = 20
)
SaludIcon <- makeIcon(
  iconUrl = "http://104.236.151.123:3838/mapapapa/assets/papa01-icono03.png",
...
Feb12 <- leaflet() %>% addProviderTiles("CartoDB.Positron") %>%
  ...
  addMarkers(popup = ~htmlEscape(Name), data=Event, icon=EventIcon,group="<span'> <img src='http://104.236.151.123:3838/mapapapa/assets/papa01-icono.png' height='20px' width='20px' style='margin-top: -5px;margin-left: 5px;'> </span>Eventos<br><br>") %>%
  addMarkers(data=Ayuda, icon=AyudaIcon,group="<span'> <img src='http://104.236.151.123:3838/mapapapa/assets/papa01-icono02.png' height='20px' width='20px' style='margin-top: -5px;margin-left: 5px;'> </span>Atención médica, hidratación y &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sanitarios<br><br>") %>%
  addMarkers(popup = ~htmlEscape(DESCRIPTION),data=CentrosSalud, icon=SaludIcon,group="<span'> <img src='http://104.236.151.123:3838/mapapapa/assets/papa01-icono03.png' height='20px' width='20px' style='margin-top: -5px;margin-left: 5px;'> </span>Centros de salud<br><br>") %>%
  ...
  addLayersControl(baseGroups = c(HTML("<b class='button1' style='float: right; font-size: 15px;'>&#10006;</b><span style='font-size:20px;color:grey;'>Febrero 12</span><br><span style='font-size:12px;color:grey;font-weight:normal;'>Ciudad de México</span><br>")),
                   overlayGroups = c("<span class='iconline' style='background-color:red;'></span>Hangar presidencial - Nunciatura &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Apostólica<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-weight:normal;'>Cierres viales de 19:45 a 20:30 horas</span><br><br>",
                                     "<span'> <img src='http://104.236.151.123:3838/mapapapa/assets/papa01-icono.png' height='20px' width='20px' style='margin-top: -5px;margin-left: 5px;'> </span>Eventos<br><br>",
                                     "<span'> <img src='http://104.236.151.123:3838/mapapapa/assets/papa01-icono02.png' height='20px' width='20px' style='margin-top: -5px;margin-left: 5px;'> </span>Atención médica, hidratación y &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sanitarios<br><br>",
                                     "<span'> <img src='http://104.236.151.123:3838/mapapapa/assets/papa01-icono03.png' height='20px' width='20px' style='margin-top: -5px;margin-left: 5px;'> </span>Centros de salud<br><br>",
...
Feb13 <- leaflet() %>% addProviderTiles("CartoDB.Positron") %>%
  ...
  addMarkers(popup = ~htmlEscape(Name),data=Event2, icon=EventIcon,group="<span'> <img src='http://104.236.151.123:3838/mapapapa/assets/papa01-icono.png' height='20px' width='20px' style='margin-top: -5px;margin-left: 5px;'> </span>Eventos<br><br>") %>%
  addMarkers(popup = ~htmlEscape(Name),data=Event3, icon=EventIcon,group="<span'> <img src='http://104.236.151.123:3838/mapapapa/assets/papa01-icono.png' height='20px' width='20px' style='margin-top: -5px;margin-left: 5px;'> </span>Eventos<br><br>") %>%
  addMarkers(data=Ayuda, icon=AyudaIcon,group="<span'> <img src='http://104.236.151.123:3838/mapapapa/assets/papa01-icono02.png' height='20px' width='20px' style='margin-top: -5px;margin-left: 5px;'> </span>Atención médica, hidratación y &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sanitarios<br><br>") %>%
  addMarkers(data=Ayuda2, icon=AyudaIcon,group="<span'> <img src='http://104.236.151.123:3838/mapapapa/assets/papa01-icono02.png' height='20px' width='20px' style='margin-top: -5px;margin-left: 5px;'> </span>Atención médica, hidratación y &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sanitarios<br><br>") %>%
  addMarkers(data=Ayuda3, icon=AyudaIcon,group="<span'> <img src='http://104.236.151.123:3838/mapapapa/assets/papa01-icono02.png' height='20px' width='20px' style='margin-top: -5px;margin-left: 5px;'> </span>Atención médica, hidratación y &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sanitarios<br><br>") %>%
  addMarkers(popup = ~htmlEscape(DESCRIPTION),data=CentrosSalud, icon=SaludIcon,group="<span'> <img src='http://104.236.151.123:3838/mapapapa/assets/papa01-icono03.png' height='20px' width='20px' style='margin-top: -5px;margin-left: 5px;'> </span>Centros de salud<br><br>") %>%
  addMarkers(popup = ~htmlEscape(NOMBRE),data=AV, icon=AngelesIcon,group="<span'> <img src='http://104.236.151.123:3838/mapapapa/assets/papa-01.png' height='20px' width='20px' style='margin-top: -5px;margin-left: 5px;'> </span>Punto de atención turística y &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;auxilio mecánico<br><br>") %>%
